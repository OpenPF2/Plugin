 ...
 */
UCLASS()
class OPENPF2GAMEFRAMEWORK_API UPF2PartyInterfaceEvents : public UObject
{
	GENERATED_BODY()
 ...
 */
class OPENPF2GAMEFRAMEWORK_API IPF2PartyInterface : public IPF2LogIdentifiableInterface
{
	GENERATED_BODY()
