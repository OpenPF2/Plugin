 ...
 */
UCLASS()
class OPENPF2GAMEFRAMEWORK_API UPF2AbilitySystemInterfaceEvents : public UObject
{
	GENERATED_BODY()
 ...
 */
class OPENPF2GAMEFRAMEWORK_API IPF2AbilitySystemInterface : public IPF2ActorComponentInterface
{
	GENERATED_BODY()
