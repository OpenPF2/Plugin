 ...
 */
UCLASS()
class OPENPF2GAMEFRAMEWORK_API UPF2OwnerTrackingInterfaceEvents : public UObject
{
	GENERATED_BODY()
 ...
 */
class OPENPF2GAMEFRAMEWORK_API IPF2OwnerTrackingInterface : public IPF2ActorComponentInterface
{
	GENERATED_BODY()
