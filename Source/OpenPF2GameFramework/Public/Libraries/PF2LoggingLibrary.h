 ...
 */
UCLASS()
class OPENPF2GAMEFRAMEWORK_API UPF2LoggingLibrary final : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	static void LogToOpenPf2Abilities(
		const FText                                          Text,
		const TScriptInterface<IPF2LogIdentifiableInterface> Subject,
		const EPF2LogVerbosityLevel                          Verbosity = VeryVerbose);
	...
	static void LogToOpenPf2Encounters(
		const FText                                          Text,
		const TScriptInterface<IPF2LogIdentifiableInterface> Subject,
		const EPF2LogVerbosityLevel                          Verbosity = VeryVerbose);
	...
	static void LogToOpenPf2Initiative(
		const FText                                          Text,
		const TScriptInterface<IPF2LogIdentifiableInterface> Subject,
		const EPF2LogVerbosityLevel                          Verbosity = VeryVerbose);
	...
	static void LogToOpenPf2Inventory(
		const FText                                          Text,
		const TScriptInterface<IPF2LogIdentifiableInterface> Subject,
		const EPF2LogVerbosityLevel                          Verbosity = VeryVerbose);
