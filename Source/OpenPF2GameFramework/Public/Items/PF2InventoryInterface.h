 ...
 */
UCLASS()
class OPENPF2GAMEFRAMEWORK_API UPF2InventoryInterfaceEvents : public UObject
{
	GENERATED_BODY()
 ...
 */
class OPENPF2GAMEFRAMEWORK_API IPF2InventoryInterface : public IPF2ActorComponentInterface
{
	GENERATED_BODY()
