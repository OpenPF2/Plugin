 ...
 */
UCLASS()
class OPENPF2GAMEFRAMEWORK_API UPF2EquippedItemsInterfaceEvents : public UObject
{
	GENERATED_BODY()
 ...
 */
class OPENPF2GAMEFRAMEWORK_API IPF2EquippedItemsInterface : public IPF2ActorComponentInterface
{
	GENERATED_BODY()
