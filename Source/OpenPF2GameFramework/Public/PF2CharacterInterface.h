 ...
 */
UCLASS()
class OPENPF2GAMEFRAMEWORK_API UPF2CharacterInterfaceEvents : public UObject
{
	GENERATED_BODY()
 ...
 */
class OPENPF2GAMEFRAMEWORK_API IPF2CharacterInterface : public IAbilitySystemInterface
{
    GENERATED_BODY()
