 ...
 */
UCLASS()
class OPENPF2GAMEFRAMEWORK_API UPF2AbilityBindingsInterfaceEvents : public UObject
{
	GENERATED_BODY()
 ...
 */
class OPENPF2GAMEFRAMEWORK_API IPF2AbilityBindingsInterface : public IPF2ActorComponentInterface
{
	GENERATED_BODY()
