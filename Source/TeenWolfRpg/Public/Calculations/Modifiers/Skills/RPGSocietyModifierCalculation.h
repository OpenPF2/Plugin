...
#include "RPGSocietyModifierCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Society skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGSocietyModifierCalculation : public URPGModifierCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGSocietyModifierCalculation();
};
