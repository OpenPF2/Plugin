...
#include "RPGNatureModifierCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Nature skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGNatureModifierCalculation : public URPGModifierCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGNatureModifierCalculation();
};
