...
#include "RPGMedicineModifierCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Medicine skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGMedicineModifierCalculation : public URPGModifierCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGMedicineModifierCalculation();
};
