...
#include "RPGSpellDifficultyClassCalculation.generated.h"
 ...
 */
UCLASS()
class TEENWOLFRPG_API URPGSpellDifficultyClassCalculation : public URPGKeyAbilityCalculationBase
{
	GENERATED_BODY()

public:
	/**
	 * Constructor for URPGSpellDifficultyClassCalculation.
	 */
	explicit URPGSpellDifficultyClassCalculation();
};
