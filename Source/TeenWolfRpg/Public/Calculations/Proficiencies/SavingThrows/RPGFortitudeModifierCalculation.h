...
#include "RPGFortitudeModifierCalculation.generated.h"

/**
 * MMC that calculates the modifier a character has in Fortitude Saving Throws.
 */
UCLASS()
class TEENWOLFRPG_API URPGFortitudeModifierCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGFortitudeModifierCalculation();
};
