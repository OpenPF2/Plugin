...
#include "RPGDiplomacyProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Diplomacy skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGDiplomacyProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGDiplomacyProficiencyCalculation();
};
