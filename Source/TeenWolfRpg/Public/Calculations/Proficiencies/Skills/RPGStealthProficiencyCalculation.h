...
#include "RPGStealthProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Stealth skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGStealthProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGStealthProficiencyCalculation();
};
