...
#include "RPGMedicineProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Medicine skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGMedicineProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGMedicineProficiencyCalculation();
};
