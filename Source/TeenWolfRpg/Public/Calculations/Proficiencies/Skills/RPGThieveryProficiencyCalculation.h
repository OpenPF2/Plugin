...
#include "RPGThieveryProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Thievery skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGThieveryProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGThieveryProficiencyCalculation();
};
