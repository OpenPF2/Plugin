...
#include "RPGNatureProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Nature skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGNatureProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGNatureProficiencyCalculation();
};
