...
#include "RPGDeceptionProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Deception skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGDeceptionProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGDeceptionProficiencyCalculation();
};
