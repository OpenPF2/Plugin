...
#include "RPGLore1ProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Lore 1 skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGLore1ProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGLore1ProficiencyCalculation();
};
