...
#include "RPGSurvivalProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Survival skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGSurvivalProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGSurvivalProficiencyCalculation();
};
