...
#include "RPGCraftingProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Crafting skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGCraftingProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGCraftingProficiencyCalculation();
};
