...
#include "RPGPerformanceProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Performance skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGPerformanceProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGPerformanceProficiencyCalculation();
};
