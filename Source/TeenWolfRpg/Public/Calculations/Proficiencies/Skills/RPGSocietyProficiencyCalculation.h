...
#include "RPGSocietyProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Society skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGSocietyProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGSocietyProficiencyCalculation();
};
