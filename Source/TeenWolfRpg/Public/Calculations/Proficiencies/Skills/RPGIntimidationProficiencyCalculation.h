...
#include "RPGIntimidationProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Intimidation skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGIntimidationProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGIntimidationProficiencyCalculation();
};
