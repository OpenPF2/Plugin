...
#include "RPGLore2ProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Lore 2 skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGLore2ProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGLore2ProficiencyCalculation();
};
