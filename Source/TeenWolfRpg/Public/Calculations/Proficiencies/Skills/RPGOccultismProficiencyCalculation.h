...
#include "RPGOccultismProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Occultism skill.
 */
UCLASS()
class TEENWOLFRPG_API URPGOccultismProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGOccultismProficiencyCalculation();
};
