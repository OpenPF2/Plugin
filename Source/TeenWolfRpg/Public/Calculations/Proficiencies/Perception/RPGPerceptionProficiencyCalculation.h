...
#include "RPGPerceptionProficiencyCalculation.generated.h"

/**
 * MMC that calculates the proficiency a character has in Perception.
 */
UCLASS()
class TEENWOLFRPG_API URPGPerceptionProficiencyCalculation : public URPGProficiencyCalculationBase
{
	GENERATED_BODY()

public:
	explicit URPGPerceptionProficiencyCalculation();
};
