...
class UPF2CharacterQueueInterface : public UPF2LogIdentifiableInterface
{
	GENERATED_BODY()
};
 ...
 */
class OPENPF2CORE_API IPF2CharacterQueueInterface : public IPF2LogIdentifiableInterface
{
	GENERATED_BODY()
