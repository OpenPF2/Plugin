...
void UPF2AttributeSet::Native_OnDamageIncomingChanged(const FGameplayEffectContextHandle& Context,
...
void UPF2AttributeSet::Native_OnHitPointsChanged(const FGameplayEffectContextHandle& Context,
