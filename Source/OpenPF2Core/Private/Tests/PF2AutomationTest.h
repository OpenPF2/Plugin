// Modified from "Runtime/Core/Public/Misc/AutomationTest.h" (Unreal Engine 5.3), which is
...
private:
	...
	public:
		...
		int8 SpecDefinitionVersion;

		FSpecDefinitionScope(): SpecDefinitionVersion(1)
		{
		}
